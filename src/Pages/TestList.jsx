...
// import { getalltest } from "../redux/slices/getDropdownoptionSlice";
import Modal from "../Component/Modal/ModalPopUp";
import { Button } from "react-bootstrap";
import { getAlltest } from "../redux/slices/getDropdownoptionSlice";
// import { getalltestlst } from "../redux/slices/getDropdownoptionSlice";
// import { getalltest } from "../redux/slices/getDropdownoptionSlice";

export default function TestList() {
  const dispatch = useDispatch();
  const { alltest } = useSelector((state) => state.dropDownOptions);
  ...
  useEffect(() => {
    if (alltest?.length > 0) {
      console.log("Using cached data:", alltest);
    } else {
      dispatch(getAlltest());
    }
  }, [alltest, dispatch]);
