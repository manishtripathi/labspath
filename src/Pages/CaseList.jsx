...
// import { getAllCases } from "../redux/slices/getDropdownoptionSlice";
...
export default function CaseList() {
  ...
  const { allCases } = useSelector((state) => state.dropDownOptions);
  ...
  useEffect(() => {
    if (allCases?.length > 0) {
      console.log("Using cached data:", allCases);
    } else {
