...
// import { getallTestCategory } from "../redux/slices/getDropdownoptionSlice";
import Modal from "../Component/Modal/ModalPopUp";
import { Button } from "react-bootstrap";
import { getAlltestCategorylst } from "../redux/slices/getDropdownoptionSlice";
// import { getallTestCategory } from "../redux/slices/getDropdownoptionSlice";
...
export default function TestCategoryList() {
  ...
  useEffect(() => {
    if (allTestCategory?.length > 0) {
      console.log("Using cached data:", allTestCategory);
    } else {
      dispatch(getAlltestCategorylst());
    }
  }, [allTestCategory, dispatch]);
