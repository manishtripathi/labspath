...
import {
  ...
  handleAddDoctor,
  handleAddTest,
  handleAddTestCategory,
} from "../../../Component/commonService";
...
const Sidebar = () => {
  ...
  return (
    <>
      {displayModal && activeFields?.length > 0 && (
        <FormModal
          fields={activeFields}
      ...
      <div className="w-64 custom-sidebarbg h-screen shadow-lg">
        ...
        <div className="mt-4">
          ...
          <MenuItem
            ...
            subMenu={[
              { label: "Open Cases", actions: {} },
              { label: "Closed Cases", actions: {} },
              { label: "Archived Cases", actions: {} },
            ]}
          />
          <MenuItem
            title="Lab"
            ...
            subMenu={[
              ...
              {
                label: "Add Tests",
                actions: () => handleFormModalSection("tests"),
              },
            ]}
          />
          {/* <MenuItem
        ...
        /> */}
          ...
          <MenuItem
            ...
            subMenu={[
              {
                label: "Add Doctor",
                actions: () => handleFormModalSection("doctor"),
              },
              {
                label: "All Doctor",
          ...
          {user?.role === "superAdmin" && (
            <MenuItem
              ...
              subMenu={[
                {
                  label: "Add Center",
                  actions: () => handleFormModalSection("center"),
                },
                {
                  label: "Add Admin",
                  actions: () => handleFormModalSection("admin"),
                },
                {
                  label: "All Centers",
